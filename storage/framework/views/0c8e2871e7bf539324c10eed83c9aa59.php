...
unset($__errorArgs, $__bag); ?>" id="namaInput" name="namaInput" value="<?php echo e(old('namaInput')); ?>" placeholder="Username">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control <?php $__errorArgs = ['emailInput'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="emailInput" name="emailInput" value="<?php echo e(old('emailInput')); ?>" placeholder="Email">
...
unset($__errorArgs, $__bag); ?>" id="passwordInput" name="passwordInput" placeholder="Password">
...
unset($__errorArgs, $__bag); ?>" id="passwordInput_confirmation" name="passwordInput_confirmation" placeholder="Konfirmasi Password">
...
</html><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/register.blade.php ENDPATH**/ ?>