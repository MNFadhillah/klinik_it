...
<?php $__env->startSection('content'); ?>
    ...
    <div class="description">
        ...
        <ol>
            ...
            <img src="<?php echo e(asset('assets/img/pemulihan_step1.jpg')); ?>" alt="Membuka Bezel" width="300">
            <br><br>

            <li>Klik kanan pada file yang ingin dipulihkan dan klik "Restore"</li>
            <img src="<?php echo e(asset('assets/img/pemulihan_step2.jpg')); ?>" alt="Membuka Bezel" width="300">
            <br><br>

            <li>Jika sudah, cek di folder tempat Anda menyimpan file tersebut. File yang dipulihkan akan ada di sana.</li>
            <img src="<?php echo e(asset('assets/img/pemulihan_step3.jpg')); ?>" alt="Membuka Bezel" width="300">
            <br><br>
        </ol>
        <div class="warning">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/user/informasi/tutorial_pemulihan.blade.php ENDPATH**/ ?>