    ...
    <div class="description">
        ...
        <ol>
            ...
            <li>Buka bezel layar:
                ...
                <img src="<?php echo e(asset('assets/img/layar_step2.jpeg')); ?>" alt="Membuka Bezel" width="300">
            </li>
        </br>
            <li>Lepaskan kabel video:
                ...
                <img src="<?php echo e(asset('assets/img/layar_step3.jpeg')); ?>" alt="Melepas Kabel Video" width="300">
            </li>
        </br>
            <li>Angkat layar lama dan pasang layar baru:
                ...
                <img src="<?php echo e(asset('assets/img/layar_step4.jpeg')); ?>" alt="Memasang Layar Baru" width="300">
            </li>
            ...
            <img src="<?php echo e(asset('assets/img/layar_step5.jpeg')); ?>" alt="Nyala" width="300">
        </ol>
        <div class="warning">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/user/informasi/tutorial_layar.blade.php ENDPATH**/ ?>