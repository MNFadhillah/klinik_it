<?php $__env->startSection('title', 'Daftar Aplikasi'); ?>
...
<button class="back-button" onclick="window.history.back();">
    ...
    <div class="image-container">
        <img src="<?php echo e(asset('assets/img/daftar_aplikasi.png')); ?>" alt="Foto Daftar Aplikasi">
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/user/informasi/daftar_aplikasi.blade.php ENDPATH**/ ?>