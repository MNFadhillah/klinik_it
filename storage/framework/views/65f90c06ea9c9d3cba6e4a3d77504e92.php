<?php $__env->startSection('title', 'Instalasi Software'); ?>
...
<button class="back-button" onclick="window.location.href='/layanan/jasa_instalasi';">
    ...
    <div class="image-container">
        <img src="<?php echo e(asset('assets/img/instalasi_software.jpg')); ?>" alt="Foto Instalasi Software">
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/user/layanan/instalasi_software.blade.php ENDPATH**/ ?>