...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="/">
            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo Klinik IT" height="80">
            Klinik IT Solution
        </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo Klinik IT" class="footer-logo"/>
...
<?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/layouts/main.blade.php ENDPATH**/ ?>