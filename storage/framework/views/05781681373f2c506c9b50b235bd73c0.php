...
<?php $__env->startSection('title', 'Tutorial Membersihkan Kipas Laptop'); ?>
    ...
    <div class="description">
        ...
        <ol>
            ...
            <li>Buka panel akses:
                ...
                <img src="<?php echo e(asset('assets/img/fan_step2.png')); ?>" alt="Buka Panel" width="300">
            </li>
        </br>
            <li>Lokasi kipas:
                <ul>
                ...
                <img src="<?php echo e(asset('assets/img/fan_step3.png')); ?>" alt="Lokasi Kipas" width="300">
            </li>
        </br>
            <li>Lepas Kipas:
                <ul>
                ...
                <img src="<?php echo e(asset('assets/img/fan_step4.png')); ?>" alt="Lokasi Kipas" width="300">
                <img src="<?php echo e(asset('assets/img/fan_step5.png')); ?>" alt="Lokasi Kipas" width="300">
            </li>
        </br>
            <li>Bersihkan kipas:
                <ul>
                ...
                <img src="<?php echo e(asset('assets/img/fan_step6.png')); ?>" alt="Lokasi Kipas" width="300">
            </li>
        </br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik_it\resources\views/user/informasi/tutorial_kipas.blade.php ENDPATH**/ ?>